...
def update_worksheet(data, worksheet):
    ...
    Update the relevant worksheet with the dtat provided
    '''
...
def calculate_surplus_data(sales_row):
    ...
    -Negative surplus indicates extra made when stock hwas sold out.
    '''
    ...
    def get_last_5_entry_sales():
        '''
        Collects columns of ata from sales worksheet, collecting
